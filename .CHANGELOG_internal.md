...
- Mark: MAI-129: bump vite/postcss/nanoid to clear Dependabot alerts, add dependabot.yml (#31)
-   - npm audit fix: vite 8.0.8 to 8.2.2, postcss 8.5.10 to 8.5.26, nanoid to 3.3.18:   - clears 5 Dependabot alerts (#23 #24 #25 #26 #29), all dev-only transitive deps under vitest
