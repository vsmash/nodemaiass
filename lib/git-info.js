...
/**
 * Flags accepted by `maiass git-info`.
 * Currently none — listed here so the global flag validator (MAI-43) knows
 * the subcommand's contract. Add a flag here when wiring it into displayGitInfo.
 */
export const FLAGS = [];
