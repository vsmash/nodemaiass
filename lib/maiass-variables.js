...
export const MAIASS_VARIABLES = {
  ...
  'MAIASS_AI_MODE': { default: 'ask', description: 'OpenAI interaction mode' },
  'MAIASS_AI_TOKEN': { default: '', description: 'OpenAI API token', sensitive: true },
  'MAIASS_AI_MODEL': { default: 'gpt-3.5-turbo', description: 'OpenAI model to use' },
  'MAIASS_AI_TEMPERATURE': { default: '0.7', description: 'OpenAI temperature setting' },
  'MAIASS_AI_MAX_CHARACTERS': { default: '8000', description: 'Max characters for OpenAI requests' },
  'MAIASS_AI_COMMIT_MESSAGE_STYLE': { default: 'bullet', description: 'Commit message style' },
  'MAIASS_AI_ENDPOINT': { default: 'https://api.openai.com/v1/chat/completions', description: 'OpenAI API endpoint' },
