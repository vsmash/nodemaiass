...
export const MAIASS_VARIABLES = {
  ...
  'MAIASS_AI_CHANGELOG_CLEANUP': { default: 'true', description: 'When AI mode is on, let AI repair malformed changelog entries during version bumps' },
  'MAIASS_AI_CHANGELOG_MODEL': { default: '', description: 'Optional override for the AI model used by --cleanup-changelogs and the inline cleanup hook (auto-picks between gpt-4o-mini and gpt-4o when unset)' },
