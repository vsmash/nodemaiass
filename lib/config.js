...
export function loadEnvironmentConfig() {
  ...
  const orderedFiles = [
    ...
    path.resolve(process.cwd(), '.env')                     // Highest priority
  ];
  
  // First, load all files except project .env without override
  ...
  // Finally, load project .env with override to ensure it takes precedence
