...
/**
 * Flags accepted by `maiass env`.
 * Currently none from the CLI — displayEnvironmentVariables accepts options
 * programmatically (showSensitive/showSources/showAll) but nothing in
 * maiass.mjs wires CLI flags through yet. Listed for the MAI-43 contract.
 */
export const FLAGS = [];
