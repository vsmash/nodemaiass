...
export function displayEnvironmentVariables(options = {}) {
  ...
  console.log(`${colors.BCyan(SYMBOLS.GLOBE + ' Environment Variables Status')}`);
  console.log();
  ...
  console.log('═'.repeat(50));
  console.log(`${colors.BGreen(SYMBOLS.CHECKMARK + ' Environment display complete')}\n`);
}
...
function displayLoadedConfigFiles() {
  console.log(`${colors.BYellow(SYMBOLS.FOLDER + ' Configuration Sources:')}`);
  console.log();
...
function displayMaiassVariables(showSensitive, loadedFiles = []) {
  console.log(`${colors.BYellow(SYMBOLS.GEAR + '  MAIASS Variables:')}`);
  console.log();
...
function displayAllEnvironmentVariables(showSensitive) {
  console.log(`${colors.BYellow(SYMBOLS.WRENCH + ' All MAIASS Environment Variables:')}`);
  console.log();
