...
`MAIASS_MODE`, `MAIASS_VERSION_PRIMARY_FILE`, `MAIASS_VERSION_PRIMARY_TYPE`, `MAIASS_DEVELOPBRANCH`, `MAIASS_MAINBRANCH`, `MAIASS_AI_COMMITS`, `MAIASS_CHANGELOG`, `MAIASS_DEBUG`
